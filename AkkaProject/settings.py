"""
Django settings for AkkaProject project.
...
SECRET_KEY = 'ky=@#f0c$0wp^%c%6zp5rh6xle%qyce^dzb-^k%q)k3*n-ihz4'
...
INSTALLED_APPS = [
    ...
    'Akkannuaire.apps.AkkannuaireConfig',
...
WSGI_APPLICATION = 'AkkaProject.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, "static_akka")
