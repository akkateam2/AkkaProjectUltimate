...
class Consultant(models.Model):
    ...
    finPeriodeEssai = models.DateField(blank=True, null=True)
    photo = models.ImageField(upload_to='uploads/',null=True, blank=True, default ='uploads/Chrysanthemum.jpg')
    dossierCompetence = models.FileField(upload_to='uploads/',null=True, blank=True, default ='default.jpg')
    cv = models.FileField(upload_to='uploads/', null=True, blank=True, default = 'default.jpg')
    dateEntreeDansLeGroupe = models.DateField(blank=True, null=True)
    francais = models.NullBooleanField(blank=True, null=True)
    ...
    anneeExperience = models.DateField(blank=True, null=True)
